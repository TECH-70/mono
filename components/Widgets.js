...
function Widgets() {
  ...
  return (
    <div className="hidden lg:inline ml-8 xl:w-[450px] space-y-5">
      ...
      <hr className="border-[#1a1a1a]"></hr>
      <hr className="border-[#1a1a1a]"></hr>
      <div className="text-[#d9d9d9] space-y-3 bg-[#212121] pt-2 rounded-sm w-11/12 xl:w-9/12">
      ...
      <div className="text-[#d9d9d9] space-y-3 bg-[#212121] pt-2 rounded-sm object-contain w-11/12 xl:w-9/12">
        <h4 className="font-bold text-xl px-4">What's up with Monotone 🎪</h4>
        <img src="https://i.ibb.co/fYkj28X/Screenshot-2022-08-29-163140.png" className="rounded-sm"></img>
      </div>
    </div>
  );
}
